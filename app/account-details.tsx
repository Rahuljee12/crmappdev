...
export default function AccountDetailsScreen() {
  ...
  useEffect(() => {
    ...
    customerUseCases.fetchCustomerAccountDetails
      .execute(accountId)
      .then((response) => {
        if (!cancelled) {
          setDetails(response);
  ...
  const viewModel: CustomerAccountDetails = details ?? {
    accountHolder: '—',
          ...
          <View style={styles.heroCard}>
            ...
            <View style={styles.heroHeader}>
              ...
              <View
                ...
                <Text style={[styles.statusText, { color: tone.textColor }]}>{viewModel.status}</Text>
              </View>
            </View>
